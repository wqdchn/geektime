...
# -*- coding:utf8 -*-
# @program: geektime
# @description: 中文数据集，使用朴素贝叶斯分类对训练集进行训练，并对测试集进行验证，并给出测试集的准确率。
# @author: wqdong
...
# 加载停用词
with open('./text-classification-file/stop/stopword.txt', 'rb') as f:
...
train_documents, train_labels = load_data('./text-classification-file/train')
test_documents, test_labels = load_data('./text-classification-file/test')
